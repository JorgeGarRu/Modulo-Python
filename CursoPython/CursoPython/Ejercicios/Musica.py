...
class Piano(Instrumento): #La clase Piano hereda de la clase Instrumento
    
    def __init__(self, marca, tipo, fecha_invencion, material, afinado,numero_teclas,electrico):
        super().__init__(marca, tipo, fecha_invencion, material, afinado)#accedemos a las variables de la clase padre
